...
def md_helper(text: str):
    ...
    pgStyle = ProgressStyle(theme, "sector")  # "sector" / "arc"
    # ~~~~~~~~~~~~~~~~~~~~~~~~
...
class MindMap:
    ...
    def __init__(self, block: Block, theme: Theme, pgStyle: ProgressStyle):
        self.map = block
        self.theme = theme
    ...
    def do_zoom(self, factor, pos: tuple[float, float]):
