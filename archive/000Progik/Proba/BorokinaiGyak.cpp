	        ...
	        switch (stoi(choice)){
	        	...
	        	case 1:{
	        		...
	        		switch (stoi(choice)){
	        			...
	        			case 1:{
	        				...
	        				*/
	        				...
	        				for (int i=0;i<linenum + badsum;++i){
	        					ofstream outf;
	        			outf.open( "borwords.txt", ofstream::out | ofstream::trunc);
	        			for (int i=0; i<linenum; ++i){
	        				outf<<toparr[i]<< "\n";
	        				outf<<eredetiwa[i][0]<< " ";
	        				outf<<gubear[i][0]<< "\n";
	        			...
	        			case 2:{
	        				...
	        				int a=0;
	        				ofstream outf;
	        				outf.open("borwords.txt", ios_base::app);
	        				ifstream topin;
	        				topin.open("topics.txt", ios::in);
	        	...
	        	case 4:{
	        		...
	        		if (sure=='y'||sure=='Y'){
	        			...
	        			if (sure=='y'||sure=='Y'){
	        				ofstream file;
	        				file.open("borwords.txt", ofstream::out | ofstream::trunc);
	        				file.close();
...
/*
NEM JÓ, EGY IDŐ UTÁN NAGY ESÉLY LESZ RÁ HOGY EGYMÁS UTÁN RAKJA A SZAVAKAT, NEM IGAZI RANDOMIZÁLÓ
