...
1. GRAVEYARD: kapd meg a kitaszajtott játékostól a sarcot... PROGRESS
2. Ha nem tud sehova lépni -> placeaimet kap, megy a zöldre
3. ha elfogy a disk, nem lép a player - ne menjen már át mínuszba a számláló
4. Movements normális megtervezése...
/*/


/*///////////////////////
*****DEBUGGING NOTES*****
Game.push_out-ban a korongok helyre csúszása vmiért nem jó.
/*/
