...
int main(){
	...
	random_device rd;
	mt19937 g(rd());
	cout << "Üdv! Ezzel a programmal angolt gyakorolhatsz.\n\nVálassz az alábbi menüpontok közül:";
AGAIN:
	cout<<"\n\t1. Számok gyakorlása\n\t2. Dátum gyakorlása\n\t3. Szavak\n\n";
	int maxopp = 3;
	string choice;
		...
		case 3:{
	        ...
	        switch (stoi(choice)){
				...
				case 3:{
					...
					cout<<endl;
					if (cg){
						cout << "\n\nAngol szavak, melyeknek "<<goodlimit<<", vagy több az indexe:\n\n";
						for (int i=0; i<linenum; ++i)
							if (gubear[i][0]>=goodlimit){
					...
					if (cb) {
						cout << "\n\nAngol szavak, melyeknek "<<badlimit<<", vagy kevesebb az indexe:\n\n";
						for (int i=0; i<linenum; ++i)
