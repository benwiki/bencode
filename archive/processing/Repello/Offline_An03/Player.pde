...
class Player{
  ...
  boolean eliminated=false, deleted=false, zombie=false, dead=false;
  ...
  void add_fleck(color col){
    Button new_color = new Button("setcolor", int(pos.x), int(pos.y),
                            pbutton.w/3, pbutton.h/3, 0, 
                            color(col), color(col), 
                            color(red(col), green(col), blue(col), 120), color(red(col), green(col), blue(col), 120), maxalpha, "oval");
                                       
    new_color.pmaster = this;                                    
    new_color.bind_pos(pbutton);
    setcolor.add(new_color);
    addToBottomExe.add(new_color);
  }
  //-----------------------------------------------------------------------------------
