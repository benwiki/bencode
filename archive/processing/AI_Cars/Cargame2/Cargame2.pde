...
void setup(){
  ...
  //my_slide = my_button.slide().setTime(3000)          // given in milliseconds
  //                                  .setMode("normal"); // possible modes: normal, whole (accelerate, then decelerate), accelerate, decelerate
